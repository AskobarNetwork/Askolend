...
module.exports = async (deployer, network) => {
  ...
  MMC = await MoneyMarketControl.at("0x9266f4f0776F3445d53Ebea148DF44b94458D7D4");
  ...
  //   "40", //Jump Multiplier Per Year(the multiplier per block after hitting a specific utilizastion point)
  //   "900000000000000000", //optimal(this is the utilizastion point or "kink" at which the jump multiplier is applied)
  //   asko, //intitial exchange rate(the rate at which the initial exchange of asset/ART is set)
  //   false
  // );
  // await MMC.updateIRM(
  //   "50000000000000000", //base rate per year(approx target base APR)
  ...
  //   "40", //Jump Multiplier Per Year(the multiplier per block after hitting a specific utilizastion point)
  //   "900000000000000000", //optimal(this is the utilizastion point or "kink" at which the jump multiplier is applied)
  //   bat, //intitial exchange rate(the rate at which the initial exchange of asset/ART is set)
  //   false
  // );
  // console.log("updated")
  // await MMC.setUpALR(
...
await MMC.transferOwnership("0xeAcF0EF0e4bE2bf664D9e6D522C0a00905f75263");
  ////////////////////////////////////////////////////////////////////////////////////////////
  console.log(
